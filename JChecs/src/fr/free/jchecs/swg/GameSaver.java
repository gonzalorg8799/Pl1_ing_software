...
/**
 * Classe prenant en charge la sauvegarde de la partie dans le fichier PGN courant.
 * 
 * @author David Cotton
 */
final class GameSaver implements Runnable
{
  ...
  private void errorDialog()
  {
    JOptionPane.showMessageDialog(_ui.getMainFrame(),
        ...
        getI18NString("action.saveGame.error.title"), JOptionPane.ERROR_MESSAGE, ICON32);
  }
