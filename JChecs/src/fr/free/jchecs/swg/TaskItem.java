...
final class TaskItem
{
   ...
   */
  TaskItem(final UI pUI, final String pIdTache, final JComponent pComposant, final Icon pIcone)
  {
    assert pUI != null;
    assert pIdTache != null;
   ...
   */
  void setFolded(final boolean pPlie)
  {
    _folded = pPlie;
   ...
   * 
   * @param pSurvol Drapeau à "vrai" pour indiquer le survol du composant par la souris.
   */
  void setMouseOver(final boolean pSurvol)
  {
    if (pSurvol)
    {
      _titleBar.setBackground(UIManager.getColor("InternalFrame.activeTitleBackground"));
      _title.setForeground(UIManager.getColor("InternalFrame.activeTitleForeground"));
    }
    else
    {
      _titleBar.setBackground(UIManager.getColor("InternalFrame.inactiveTitleBackground"));
      _title.setForeground(UIManager.getColor("InternalFrame.inactiveTitleForeground"));
    }
  }
