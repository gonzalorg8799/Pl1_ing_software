...
/**
 * Composant affichant la valeur de l'évaluation de la position courante d'une partie.
 * 
 * @author David Cotton
 */
final class EvalPanel implements PropertyChangeListener
{
  ...
  /**
   * Construit un nouveau composant d'affichage de l'évaluation de la position.
   * 
