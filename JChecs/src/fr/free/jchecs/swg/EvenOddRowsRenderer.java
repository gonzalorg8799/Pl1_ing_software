...
final class EvenOddRowsRenderer extends DefaultTableCellRenderer
{
   ...
   * 
   * @param pTable Table en cours de dessin.
   * @param pObjet Objet à afficher.
   * @param pSelection Drapeau indiquant si la cellule est sélectionnée.
   * @param pFocus Drapeau indiquant si la cellule a le focus.
   * @param pLigne Numéro de ligne de la cellule.
   * @param pColonne Numéro de colonne de la cellule.
   * @return Composant à afficher.
   */
  @Override
  public Component getTableCellRendererComponent(final JTable pTable, final Object pObjet,
      final boolean pSelection, final boolean pFocus, final int pLigne, final int pColonne)
  {
    final Component res =
        super.getTableCellRendererComponent(pTable, pObjet, pSelection, pFocus, pLigne, pColonne);
